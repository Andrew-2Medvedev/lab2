...
public interface Point {
    ...
    /**
     * Возвращает расстояние до заданной точки.
     * <p>
     * Расстоя́ние, в широком смысле, степень (мера) удалённости объектов друг от друга.
     *
     * @return d-расстояние до точки
     *
     * @see <a href="https://ru.wikipedia.org/wiki/%D0%A0%D0%B0%D1%81%D1%81%D1%82%D0%BE%D1%8F%D0%BD%D0%B8%D0%B5">Расстояние</a>
     */

    void move(float dx, float dy);

    float distanceFrom(Point b);
}
